...
v = Path("../../version").open(encoding = "utf-8").read().splitlines()
version = v[0].strip()
...
github_repo = "catvehicle"
github_nb_repo = "catvehicle"
...
htmlhelp_basename = "catvehicledoc"
...
github_url_catvehicle = "https://github.com/jmscslgroup/catvehicle/tree/master"
...
def modurl(qualname):
    ...
    github_url = github_url_catvehicle
